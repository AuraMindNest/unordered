...
定义
link:reference/unordered_map.html#unordered_map[`boost::unordered++_++map`]、link:reference/unordered_multimap.html#unordered_multimap[`boost::unordered++_++multimap`]
以及相关函数和别名模板。
